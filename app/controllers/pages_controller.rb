class PagesController < ApplicationController
  ...
  def index
    # @name = params[:name] 
    # @ означает, что переменная будет видна во view, связанным с этим контроллером(в данном случае views/pages/index.html.erb), а также в других методах контроллера
  end
end